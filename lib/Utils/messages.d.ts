...
export declare const getMediaTypeFromContentType: (contentType: keyof proto.IMessage | undefined, content?: proto.IMessage) => import('../Defaults/index.js').MediaType | undefined;
/**
