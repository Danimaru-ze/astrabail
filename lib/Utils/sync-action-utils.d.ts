...
import type { AstraBailEventEmitter, AstraBailEventMap, Contact } from '../Types/index.js';
...
export type LidMappingUpdateResult = {
    ...
    data: AstraBailEventMap['lid-mapping.update'];
};
...
export declare const emitSyncActionResults: (ev: AstraBailEventEmitter, results: SyncActionResult[]) => void;
